...
public class ProblemUserFifthAddAndRemoveButtonTest {
    ...
    public static void main(String[] args) {
        ...
        // Click the fifth item's 'ADD TO CART' button.
        ...
        Assert.assertEquals(driver.findElement(By.xpath("//div[@class='inventory_item_name']")).getText(), "Sauce Labs Onesie");
